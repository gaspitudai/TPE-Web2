<?php
    ...
    class APICategoryController extends APIController {
        ...
        public function getAll() {
            ...
            $quantityTicketsByCategory = $this->categoryCtrl->getQuantityTicketsByCategory();
            $categoryData = array($categories, $quantityTicketsByCategory);
            //json_decode($categoryData);
            $this->view->response($categoryData, 200);
        }
